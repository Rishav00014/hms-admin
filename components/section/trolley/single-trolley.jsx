  ...
  return (
    <section className="bg-white rounded-xl text-gray-600 text-sm p-3 lg:p-10">
      ...
      <div>
        ...
        <div className="mt-10 flex flex-col lg:flex-row gap-4 justify-between items-center text-sm text-gray-50 w-full bg-blue-400 px-8 py-4 rounded-xl">
          <div className="">
            <h1 className="font-bold  text-4xl pb-2">
              Add New Hall
            </h1>
            <p>Streamline Your Hall Today</p>
          </div>
          <button
        ...
        {!dataLoading && serviceHistory?.length > 0 && (
          <div className="w-full bg-blue-100 rounded-xl mt-12 pb-6 shadow">
            <div className="p-5 flex flex-col lg:flex-row gap-4 justify-between w-full">
